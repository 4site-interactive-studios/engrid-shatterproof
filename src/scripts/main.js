export const customScript = function (App, DonationFrequency) {
  ...
  App.addHtml(
    '<div class="upsell-message"><p class="recurring-frequency-y-show"><strong><em>Thank you!</em></strong> Your monthly does even more to help people who are living with addiction.</p><p class="recurring-frequency-n-show"><em>Giving monthly</em> is the <strong>best way</strong> to help provide access to quality addiction treatment.</p><span class="arrow"></span></div>',
